/* =====================================================
    BUSINESS QUESTION:
    How do selected campaigns compare across seasons?
...
, CTE_RANK AS (
    SELECT SEASON, CAMPAIGN_ID, CAMPAIGN_NAME, Total_Order, SPEND, PROFIT, CTR, CPC, CPM, CR, ROAS, ROI, DISCOUNT, CLICKS, IMPRESSION,
